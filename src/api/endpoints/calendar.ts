...
export const getCalendarEvents = () =>
  apiClient
    .get<Event[]>('/calendar/events')
    .then((res) => EventSchema.array().parse(res.data));

// Create Calendar Event
export const createCalendarEvent = (data: EventCreate) =>
  apiClient
    .post<Event>('/calendar/events', data)
    .then((res) => EventSchema.parse(res.data));
...
export const getGoogleCalendarAuthUrl = () =>
  apiClient
    .get<{ authUrl: string }>('/calendar/google/auth')
    .then((res) => res.data);
...
export const syncWithGoogleCalendar = () =>
  apiClient
    .post<{ imported: number; events: Event[] }>('/calendar/google/sync')
    .then((res) => ({
...
export const disconnectGoogleCalendar = () =>
  apiClient
    .delete<{ message: string }>('/calendar/google/disconnect')
    .then((res) => res.data);
