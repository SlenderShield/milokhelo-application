...
export const registerPushToken = (data: DeviceTokenRegister) =>
  apiClient.post<{ message: string }>('/notifications/push-token', data).then(res => res.data);
...
export const sendInvitation = (data: InvitationCreate) =>
  apiClient.post<Invitation>('/invitations', data).then(res => InvitationSchema.parse(res.data));

// Get Invitations
export const getInvitations = () =>
  apiClient.get<Invitation[]>('/invitations').then(res => InvitationSchema.array().parse(res.data));
