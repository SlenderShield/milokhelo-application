...
export const getMyProfile = () =>
  apiClient.get<UserProfile>('/users/me').then(res => UserProfileSchema.parse(res.data));

// Update Current User Profile
export const updateMyProfile = (data: UserUpdate) =>
  apiClient.put<UserProfile>('/users/me', data).then(res => UserProfileSchema.parse(res.data));
...
export const getUserById = (id: string) =>
  apiClient.get<UserProfile>(`/users/${id}`).then(res => UserProfileSchema.parse(res.data));
...
export const addFriend = (friendId: string) =>
  apiClient.post<{ message: string }>(`/users/${friendId}/friend`).then(res => res.data);

// Remove Friend
export const removeFriend = (friendId: string) =>
  apiClient.delete<{ message: string }>(`/users/${friendId}/friend`).then(res => res.data);
